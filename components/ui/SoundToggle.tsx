...
export default function SoundToggle({ enabled, onToggle }: SoundToggleProps) {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-50 flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-navy-deep/70 text-2xl text-white/90 backdrop-blur-md transition-all active:scale-95 hover:bg-navy-deep/85"
    >
